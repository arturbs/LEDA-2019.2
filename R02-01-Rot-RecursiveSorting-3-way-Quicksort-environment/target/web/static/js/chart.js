// Wrapping in nv.addGraph allows for '0 timeout render', stores rendered charts in nv.graphs, and may do more in the future... it's NOT required
	...
	var data = [{values:[{x:10,y:0.0},{x:100,y:0.0},{x:500,y:0.0},{x:1000,y:0.0},{x:2000,y:0.0},{x:4000,y:0.0},{x:6000,y:0.0},{x:10000,y:0.0},{x:15000,y:0.0},{x:20000,y:0.0}],key:"MergeSort",color:colors[0]}];;
